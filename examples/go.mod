...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/exporter/rabbitmqexporter v0.140.1
...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/rabbitmq v0.140.1 // indirect
